...
class MainApp(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        app_icon = menuBar.addMenu(QIcon("google_docs.png"), "icon")

        # setting  the geometry of window
        self.setGeometry(0, 0, 400, 300)
        
        # save icon 
        save_action = QAction(QIcon("saveicon.png"), 'Save', self)
        save_action.triggered.connect(self.file_save)
        app_icon.addAction(save_action)
        
        # Window icon 
        self.setWindowIcon(QtGui.QIcon('google_docs.png'))
        
        # set the title
        self.setWindowTitle("NS WORD")
